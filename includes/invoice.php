                ...
                <div class="receipt-header">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="receipt-left">
                            <img class="img-responsive" alt="logo" src="images/instinct.png" style="width: 100px; ;">
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                        <div class="receipt-right">
                            <h5>Instinct Seekers</h5>
                            <p>+91 8666455213     <i class="fa fa-phone"></i></p>
                            <p>InstinctSeekers@gmail.com <i class="fa fa-envelope-o"></i></p>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <p>
                                <strong><i class="fa fa-inr"></i> <?php echo $payable; ?>/-</strong>
                            </p>
                            <p>
