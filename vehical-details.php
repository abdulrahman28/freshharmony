...
$sql="INSERT INTO `tblbooking` (`id`, `userEmail`, `VehicleId`, `FromDate`, `ToDate`, `Status`, `PostingDate`) VALUES ('', '$useremail', '$vhid', '$fromdate', '$todate', '$status', current_timestamp());";
if (mysqli_query($con,$sql )) {
  header('location: includes/payment.php');
}
}
/*
...
$_SESSION['Vimage1'] =$result->Vimage1;
 $_SESSION['BrandName'] =$result->BrandName;
 $_SESSION['VehiclesTitle'] =$result->VehiclesTitle;
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="includes/login/login-user.php" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
